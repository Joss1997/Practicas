...
function SignupForm() {
  ...
  return (
    <form className={styles.form} onSubmit={handleSignup}>
      ...
      <input className={styles.input} type="password" placeholder="Confirmar Contraseña" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
